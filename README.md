...
Этот репозиторий содержит релизы и инструкции для установки Ryazhenka CFW.

---

**Ключевые компоненты**

- `Ryazhahand-Overlay` — система управляющая оверлеями, пользовательскими настройками. Основан на базе Ultrahand. Переаботано: Dimasick-git.
...
Спасибо бошьше всем, участвоовалекте участвоовал и участвует в этом кто,э. спасибо за помощь в написании кода, а также благодарность коммюнтти за отличные идеи!
---
